        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 min-h-[60vh] items-stretch">
            ...
            <div className="relative min-h-[50vw] md:min-h-full order-1 md:order-2">
              <Image src="https://res.cloudinary.com/dhngfy4p6/image/upload/f_auto,q_auto/wwme-hero" alt="Anna Wallace" fill className="object-cover object-top" priority />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-secondary/50 py-20 md:py-28">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">A grounded space for women who've done the work and are ready to step into the next chapter of their lives.</p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div className="relative aspect-[4/3] bg-muted overflow-hidden">
              <Image src="https://res.cloudinary.com/dhngfy4p6/image/upload/v1775860766/workshops-and-dinners_event-card_xxrcyd.svg" alt="Workshop facilitation" fill className="object-cover" />
            </div>
            <div>
      ...
      <section className="bg-secondary/50 py-20 md:py-28">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="max-w-2xl">
            <h2 className="text-3xl md:text-4xl font-serif text-foreground mb-6">Speaking</h2>
            <div className="space-y-5 text-muted-foreground leading-relaxed">
              <p>I speak on the themes I explore in my podcast and coaching work: family patterns, self-understanding, relationships, and what it means to choose a different path.</p>
              <p>If you're looking for a speaker for a conference, corporate event, or panel, get in touch.</p>
            </div>
            <div className="mt-10">
              <Button asChild variant="outline" size="lg" className="rounded-none px-8"><Link href="/contact">Get in touch</Link></Button>
            </div>
          </div>
        </div>
      </section>
